...
$sql = "SELECT u.id,u.name,u.phone_number,u.email,c.faaliyetAlani,c.adres,c.basvuruDurumu,c.aciklama
        FROM users u join company c on c.userId=u.id where u.tur=3 and c.basvuruDurumu=-1";
