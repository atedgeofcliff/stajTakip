...
$sql="SELECT comId from degerlendirmeformu  where ogrenciId='$ogrId'";
...
$sqlfirma="SELECT id,soru1,soru2,soru3,soru4,soru5,soru6,soru7,soru8,soru9,soru10
FROM degerlendirmeformu where comId='$comId[0]' and  ogrenciId='$ogrId' ";
...
if ($result->num_rows >0) {
    ...
    $MSG = 'Böyle Bir Form Bulunmamaktadır.'; 
