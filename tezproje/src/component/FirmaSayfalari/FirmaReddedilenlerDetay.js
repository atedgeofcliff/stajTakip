...
class FirmaReddedilenlerDetay extends Component {
  constructor(props) {
    super(props);
    this.state = {
      durum: 'boş',
  ...
  OnaylamaReddetme = () => {
    ...
    fetch(getIp() + '/react-native-insert/FirmaReddedilenlerButonları.php', {
      method: 'POST',
      headers: {
  ...
  renderAlert() {
    Alert.alert(
      ...
      [
        ...
        { text: 'Kaldır', onPress: () => { this.OnaylamaReddetme(this.setState.durum = 'red') } }
      ],
      { cancelable: false }
    );
  }
...
export default FirmaReddedilenlerDetay;