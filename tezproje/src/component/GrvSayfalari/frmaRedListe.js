...
class frmaRedListe extends Component {
  constructor(props) {
    super(props);
    this.state = {}
  }
  async componentDidMount() {
    ...
    try {
      ...
      const response = await fetch(getIp() + '/react-native-insert/fRedListe.php');
      ...
      Alert.alert("Reddedilen Firma Yok!");
  ...
  // componentWillMount(){
  //   console.log("hatayı engellemek için bu sayfaya geri döndüğünde ne yapacağını bilsin diye sanıyorum:/ yok öyle bir şey yaaa..")
  // }
  render() {
    ...
    return (
      <>
        <LinearGradient colors={['#D9CAC1', '#A3B0D9']}
          ...
          <Text style={{ color: 'white', fontSize: 20, fontWeight: 'bold' }}>REDDEDİLEN FİRMALAR</Text>
